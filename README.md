...
The development environment loads both optional badge mods by default for integration testing. Use the following command to verify startup without either badge mod:
